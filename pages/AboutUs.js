...
const AboutUs = () => {
  ...
  <div className="flex flex-col py-[120px] px-[30px] items-center justify-start bg-[url(/hero-section@3x.png)] bg-cover bg-no-repeat bg-top text-center text-33xl text-gray-white font-body-regular-400">
