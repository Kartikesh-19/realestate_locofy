...
const AboutUs = () => {
  ...
  <div className="flex flex-col py-[400px] px-[30px] items-center justify-start bg-[url(/hero-section@3x.png)] bg-cover bg-no-repeat bg-top text-center text-33xl text-gray-white font-body-regular-400">
    <div className="flex flex-col items-center justify-end gap-[24px] md:max-w-full bg-black bg-opacity-50 p-5 rounded-lg">
      <div className="leading-[58px] font-semibold text-white">
        About Us
      </div>
      <hr className="border-t border-primary-50 my-4" />
      <div className="flex flex-col items-center justify-start gap-[45px] text-white">
        <div className="relative text-xm leading-[28px] font-body-regular-800 text-primary-50">
          Our History
        </div>
        ...
        <div className="self-stretch relative text-xm leading-[28px] font-body-regular-600 text-primary-50">
            Our Expertise
           </div>
